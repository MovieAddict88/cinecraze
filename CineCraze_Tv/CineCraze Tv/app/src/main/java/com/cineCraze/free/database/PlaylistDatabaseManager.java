...
public class PlaylistDatabaseManager extends SQLiteOpenHelper {
    ...
    public boolean initializeDatabase() {
        try {
            ...
            // Ensure database exists; it must be downloaded by PlaylistDownloadManager first
            ...
            if (!localDbFile.exists()) {
                Log.w(TAG, "Local database file not found - expected to be downloaded. Initialization aborted.");
                return false;
            }
    ...
    // Assets copy removed; database must be downloaded first
