...
import com.cinecraze.free.utils.EnhancedUpdateManager;

import java.io.File;

/**
 * Enhanced Activity for downloading the playlist database using manifest system
 */
public class PlaylistDownloadActivityEnhanced extends Activity implements EnhancedUpdateManager.UpdateCallback {
    
    private static final String TAG = "PlaylistDownloadEnhanced";
    ...
    private EnhancedUpdateManager updateManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        updateManager = new EnhancedUpdateManager(this);
    ...
    @Override
    public void onUpdateAvailable(EnhancedUpdateManager.ManifestInfo manifestInfo) {
        runOnUiThread(() -> {
