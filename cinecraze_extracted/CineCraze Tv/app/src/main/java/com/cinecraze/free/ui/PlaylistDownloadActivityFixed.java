...
/**
 * Fixed Activity for downloading the playlist database
 * Properly handles update detection and database replacement
 */
public class PlaylistDownloadActivityFixed extends Activity implements EnhancedUpdateManagerFixed.UpdateCallback {
    
    private static final String TAG = "PlaylistDownloadFixed";
